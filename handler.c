...
/**
 * handler - Format specifiers
 * @str: String chaaracter
 * @list: outline the list of arguments
 * Return: size of arguments with total size of base string
 */
...
/**
 * percent_handler - manage the percent format
 * @str: format string
 * @list: List of all arguments
 * @i: Iterator
 * Return: numbers of elements printed with the size
 */
